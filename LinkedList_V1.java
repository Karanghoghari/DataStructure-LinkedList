...
public class Linked_List {
    public static void main(String[] args) {
        ...
        for (int retailer = 1; retailer <= 10; retailer++) {
            ...
            int supplier = random.nextInt(100) + 1; 

            // Random requirement between 1 and 100
            int requirement = random.nextInt(100) + 1; 
        ...
        for (Supply supply : supplyList) {
            if (remainingSupplies >= supply.requirement) {
                remainingSupplies -= supply.requirement;
                supply.supplier = supply.requirement;
            } else {
                supply.supplier = remainingSupplies;
                remainingSupplies = 0;
            }
        }
        ...
        for (Supply supply : supplyList) {
            ...
            System.out.println("Retailer " + (supply.retailer<10 ? ("0"+supply.retailer) : supply.retailer) + ": " + unsatisfied + " unsatisfied");
        }

        // Calculate total unsatisfied requirements
        int totalUnsatisfied = supplyList.stream().mapToInt(supply -> Math.max(supply.requirement - supply.supplier, 0)).sum();
...
// stream(): This method is called on the supplyList, creating a stream of elements from the list. A stream is a sequence of elements that you can process in various ways using functional-style operations.
